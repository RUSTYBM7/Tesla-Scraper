  ...
  return (
    ...
    >
      ...
      <div style={{
        ...
        <h2 style={{ fontSize:'clamp(24px,3.5vw,40px)', fontWeight:600, color:'#fff', marginBottom:'10px', textAlign:'center', textShadow:'0 1px 8px rgba(0,0,0,.4)', letterSpacing:'-0.5px' }}>
          Navigate on Autopilot
        </h2>
        <p style={{ fontSize:'16px', color:'rgba(255,255,255,.8)', marginBottom:'28px', textAlign:'center', maxWidth:'480px' }}>
          Full Self-Driving (Supervised) — available for $99/mo
        </p>
        <div style={{ display:'flex', gap:'12px', flexWrap:'wrap', justifyContent:'center' }}>
          <button onClick={() => navigate('/vehicles/model-3')} style={{
            padding:'13px 36px', borderRadius:'4px', fontSize:'14px', fontWeight:500, cursor:'pointer',
            background:'rgba(23,26,32,.86)', color:'#fff', border:'none',
          ...
          <button style={{
            padding:'13px 36px', borderRadius:'4px', fontSize:'14px', fontWeight:500, cursor:'pointer',
            background:'rgba(255,255,255,.68)', color:'#171a20', border:'none',
            backdropFilter:'blur(6px)', transition:'background .2s, transform .15s',
          }}
