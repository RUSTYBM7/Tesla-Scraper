...
const slides: Slide[] = [
  {
    ...
    btnPrimaryRoute: '/contact?subject=order&vehicle=model-y', btnSecondaryRoute: '/vehicles/model-y',
  ...
  },
  {
    ...
    btnPrimary: 'Order Now', btnSecondary: 'Learn More',
    btnPrimaryStyle: 'dark',
    btnPrimaryRoute: '/contact?subject=order&vehicle=model-3', btnSecondaryRoute: '/vehicles/model-3',
  ...
  },
  {
    ...
    btnPrimary: 'Order Now', btnSecondary: 'Learn More',
    btnPrimaryStyle: 'dark',
    btnPrimaryRoute: '/contact?subject=order&vehicle=model-x', btnSecondaryRoute: '/vehicles/model-x',
  ...
  },
  {
    ...
    btnPrimary: 'Order Now', btnSecondary: 'Learn More',
    btnPrimaryStyle: 'dark',
    btnPrimaryRoute: '/contact?subject=order&vehicle=cybertruck', btnSecondaryRoute: '/vehicles/cybertruck',
