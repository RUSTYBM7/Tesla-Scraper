    ...
    >
      ...
      <div ref={bgRef} style={{
        ...
        <div style={{
          ...
          backgroundImage: `url(${BASE}tesla-supercharger-new.jpg)`,
      ...
      <div style={{
        ...
        background: 'linear-gradient(to bottom, rgba(0,0,0,.12) 0%, rgba(0,0,0,.58) 100%)',
      }} />
      ...
      <div style={{
        ...
        display: 'flex', gap: '64px', zIndex: 2,
        opacity: visible ? 1 : 0, transition: 'opacity .9s ease .3s',
      }}>
        {stats.map(({ val, label }) => (
          <div key={label} style={{ textAlign: 'center' }}>
            <div style={{ fontSize: '40px', fontWeight: 700, color: '#fff', lineHeight: 1 }}>{val}</div>
      ...
      <div style={{
        ...
        <p style={{ fontSize: '16px', color: 'rgba(255,255,255,.8)', marginBottom: '26px', textAlign: 'center' }}>
          Go anywhere with the world's largest fast charging network
        </p>
        <div style={{ display: 'flex', gap: '12px' }}>
          {['Find a Charger', 'Learn More'].map((label, i) => (
