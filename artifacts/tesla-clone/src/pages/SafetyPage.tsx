              ...
              <div key={r.model} style={{ background: '#0d1117', borderRadius: '14px', padding: '24px 16px', textAlign: 'center' }}>
                ...
                <div style={{ display: 'flex', gap: '2px', justifyContent: 'center', marginBottom: '10px' }}>
                  {Array.from({ length: r.stars }).map((_, i) => (
                    <svg key={i} viewBox="0 0 24 24" width="16" height="16" fill="#f59e0b"><path d="M12 2l3.09 6.26L22 9.27l-5 4.87 1.18 6.88L12 17.77l-6.18 3.25L7 14.14 2 9.27l6.91-1.01L12 2z"/></svg>
                  ))}
                </div>
